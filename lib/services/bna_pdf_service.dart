...
class BnaPdfService {
  static Future<Uint8List> generatePdf(BnaModel data) async {
        ...
        build: (pw.Context context) {
          return pw.Column(
            ...
            children: [
              ...
              pw.Center(
                child: pw.Text(
                  'SURAT PERMINTAAN BALIK NAMA LAYANAN',
                  style: pw.TextStyle(
                    fontSize: 11,
...
if (data.namaKuasa.isNotEmpty) ...[
  ...
  pw.Row(children: [pw.SizedBox(width: 100, child: pw.Text('Nomor Identitas')), pw.Text(': ${data.nomorIdentitasKuasa}')]),
              ...
              pw.SizedBox(height: 4),
              pw.Text(
                'BAHWA, PELANGGAN adalah benar pihak yang berlangganan Layanan Indibiz berdasarkan Kontrak Berlangganan, dan dengan ini mengajukan permintaan Balik Nama Layanan Indibiz, sebagai berikut:',
              ...
              // Detail Balik Nama
              pw.Text(
                'Jenis Permohonan : Balik Nama / Ganti Nama',
              ...
              pw.Padding(
                ...
                child: pw.Column(
                  ...
                  children: [
                    pw.Text(
                      '1.  Permohonan ini berlaku sejak ditandatanganinya Surat Permintaan Balik Nama Layanan Indibiz ini.',
                      style: const pw.TextStyle(fontSize: 8),
                    ),
                    pw.Text(
                      '2.  Surat Permintaan Balik Nama Layanan Indibiz ini merupakan satu kesatuan yang tidak terpisahkan dengan Kontrak Berlangganan yang telah ditandatanganinya PT Telkom Indonesia (Persero) Tbk dengan PELANGGAN.',
                      style: const pw.TextStyle(fontSize: 8),
                    ),
                  ],
                ),
              ...
              pw.Row(
                ...
                children: [
                  pw.Column(
                    children: [
                      pw.Text('Penanggung Jawab Telkom',
                          style: pw.TextStyle(fontSize: 9, fontWeight: pw.FontWeight.bold)),
                      pw.SizedBox(height: 40),
                      pw.Text('(nama penanggung jawab)', style: const pw.TextStyle(fontSize: 8.5)),
                    ],
                  ),
                  pw.Column(
                    children: [
