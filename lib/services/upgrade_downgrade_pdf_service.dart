...
if (data.namaKuasa.isNotEmpty) ...[
  ...
  pw.Row(children: [pw.SizedBox(width: 100, child: pw.Text('Nomor Identitas')), pw.Text(': ${data.nomorIdentitasKuasa}')]),
                ...
                text: pw.TextSpan(
                  ...
                  children: [
                    ...
                    pw.TextSpan(
                      ...
                      style: pw.TextStyle(
                        fontWeight: pw.FontWeight.bold,
                        decoration: isUpgrade ? pw.TextDecoration.none : pw.TextDecoration.lineThrough,
                      ),
                    ),
                    ...
                    const pw.TextSpan(
                      text: ' (coret salah satu) Layanan Indibiz, sebagai berikut:',
                    ),
                  ],
                ),
              ),
              ...
              _buildSubRow('Keterangan Tambahan', data.keteranganTambahanDetail),
              pw.SizedBox(height: 10),
              ...
              pw.Padding(
                ...
                child: pw.Column(
                  ...
                  children: [
                    pw.Text(
                      '1.  Permohonan ini berlaku sejak ditandatanganinya Surat Permintaan Upgrade/Downgrade Layanan ini.',
                      style: const pw.TextStyle(fontSize: 8),
                    ),
                    pw.Text(
                      '2.  Surat Permintaan Upgrade/Downgrade Layanan ini merupakan satu kesatuan yang tidak terpisahkan dengan Kontrak Berlangganan yang telah ditandatanganinya PT Telkom Indonesia (Persero) Tbk dengan PELANGGAN.',
                      style: const pw.TextStyle(fontSize: 8),
                    ),
                  ],
                ),
