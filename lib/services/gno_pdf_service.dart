...
if (data.namaKuasa.isNotEmpty) ...[
  ...
  pw.Row(children: [pw.SizedBox(width: 100, child: pw.Text('Nomor Identitas')), pw.Text(': ${data.nomorIdentitasKuasa}')]),
              ...
              _buildSubRow('c. Nomor Internet Lama', data.noInternetLama),
              _buildSubRow('d. Nomor Internet Baru', data.noInternetBaru),
              ...
              pw.Padding(
                ...
                child: pw.Column(
                  ...
                  children: [
                    pw.Text(
                      '1.  Permohonan ini berlaku sejak ditandatanganinya Surat Permintaan Ganti Nomor Layanan Indibiz ini.',
                      style: const pw.TextStyle(fontSize: 8),
                    ),
                    pw.Text(
                      '2.  Surat Permintaan Ganti Nomor Layanan Indibiz ini merupakan satu kesatuan yang tidak terpisahkan dengan Kontrak Berlangganan yang telah ditandatanganinya PT Telkom Indonesia (Persero) Tbk dengan PELANGGAN.',
                      style: const pw.TextStyle(fontSize: 8),
                    ),
                  ],
                ),
